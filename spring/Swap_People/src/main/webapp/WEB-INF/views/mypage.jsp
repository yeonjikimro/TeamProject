	...
	<section>
		...
		<div class="sell">
			...
			<input type='button' value='업로드'
				onclick='window.open("/customer.jsp")'>
		</div>
		<hr>
		<div class="stuff">
			<div class="picture">
			...
			<div class="context">
				...
				<div class="boxes">
					<a class="box">Like 5</a> <a class="box">수정하기</a>
				</div>
			</div>
			<div class="ing">
				<a
					onclick='window.open("/mypage_ing.jsp", "complete", "width= 300px, height=300px")'>
					판매중 </a>
			</div>
		</div>
		<div class="stuff">
			...
			<div class="context">
				...
				<div class="boxes">
					<a class="box">Like 1</a> <a class="box">수정하기</a>
				</div>
			</div>
			<div class="ing">판매중</div>
		</div>
	</section>
	<footer>
		<div>

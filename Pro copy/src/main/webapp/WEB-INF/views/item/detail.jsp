	...
	<section>
		<div class="total">
			<div class="container">
				...
				<div class="ticker">
					<div class="images2">
						<img src="../images/bicycle2.jpeg" /> <img
							src="../images/bicycle3.jpeg" /> <img
							src="../images/bicycle4.jpeg" /> <img
							src="../images/bicycle5.jpeg" /> <img
							src="../images/bicycle6.jpeg" />
					</div>
				</div>
			</div>
			<div class="pro">
				...
				<div class="trading">
					<div class="trading2">
						...
						<ul>
							<li>거래 주소(위치/장소) : ${posting.addr}</li>
							<li>상세주소( ${posting.addr_dtl} )</li>
						</ul>
						<ul>
							<!-- dataset -->
							<li>카테고리 : ${posting.cat_name}
							</li>
						</ul>
					</div>
					<div class="tag">
						...
						<input type="text" value="#쿠폰 #핸드폰 #아이폰 # 냉장고 # 갤럭시 # 아이패드 # 포토샵"
							class="input">
